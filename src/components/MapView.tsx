    ...
    <div className="relative w-full h-full bg-[#0A0A0A]">
      ...
      {!showOnboarding && (
        <button
          ...
          className="absolute top-4 right-4 z-[900] bg-[#141414] border border-[#2A2A2A] w-11 h-11 rounded-full flex items-center justify-center text-[#D4AF37] active:bg-[#D4AF37]/10 active:border-[#D4AF37]/30 transition-all shadow-lg safe-top"
        >
